...
namespace GraphLinq.Core.Visitors.SelectExpressionVisitor.Abstractions
{
    internal abstract class SelectExpressionVisitorBase : VisitorBase
    {
        ...
        public SelectExpressionVisitorBase(SelectExpressionVisitorConfiguration configuration)
        {
